...
export const links = [
  { //button kahan gia dk asl me button name yahan se ja rha or yhi name as a url bhi ja rha me apko dikhata houn
    // asay ni kro. link ka attribute alag kro or name ka alag 
    title: 'Dashboard',
    links: [
     
      {
        name: 'Seizure Record',
        url: 'Seizure Record', // ya kesa ho rha tha yse wesay phlay as a route? yh do abhi bs aese hi bnaye huay inke pages nihsta wese inka url bhi inke name jesa hona, yor hai dashboiard me hii like stream ok hogia
        icon: <FiShoppingBag />,
      },
      {
        name: 'Stream',
        url: '/Dashboard/Stream ', // ya kesa ho rha tha yse wesay phlay as a route? yh do abhi bs aese hi bnaye huay inke pages nihsta wese inka url bhi inke name jesa hona, yor hai dashboiard me hii like stream ok hogia
        icon: <FiShoppingBag />,
      },
      {
        name: 'Vitals',
